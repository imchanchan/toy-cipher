...
print("\n(3-1) s_hat =", end="")
kyber.printvector(s_hat)
print("(3-2) e_hat =", end="")
kyber.printvector(e_hat)
...
print("\n(5-1) ek_PKE =", end="")
kyber.printarray(ek_PKE)
print("(5-2) dk_PKE =", end="")
kyber.printarray(dk_PKE)
...
print("\n\n========================== [[ML-KEM.Encaps(ek) Start]] ==========================")

# 1: m <- B^1
m = [170]
print("1-1. m = [ 0x%02x ]" %(m[0]))
...
rho = ek_PKE    [24:]
print("(1-1) t_hat_decoded =", end="")
kyber.printvector(t_hat_decoded)
# print("(1-2) rho = ", rho)
...
for i in range(2):
    for j in range(2):
        print("[", end=" ")
        for k in range(8):
            print("%4d, " %(A_mat_Encrypt[i][j][k]), end="")
        print("]", end=" ")
    print("\t")
...
print("(2-2) r_hat  =", end="")
kyber.printvector(r_hat)
print("(2-3) e1_vec =", end="")
kyber.printvector(e1_vec)
print("(2-4) e2     =", end="")
kyber.printarray(e2)
...
# print("3. u_vec_temp = ", u_vec_temp)

# 5.2 NTT inverse
for k in range(2):
    u_vec_temp[k] = kyber.inv_NTT(u_vec_temp[k])
# print("\n3. NTT^(-1)(u_vec_temp) = ", u_vec_temp)
...
print("1-1. dk_PKE_decaps =", end="")
kyber.printarray(dk_PKE_decaps)
print("1-2. ek_PKE_decaps =", end="")
kyber.printarray(ek_PKE_decaps)
print("1-3. h_decaps =", end="")
kyber.printarray(h_decaps)
print("1-4. z_decaps =", end="")
kyber.printarray(z_decaps)
...
print("\n(5-1) m_decrypt = [ 0x%02x ]" %(m_decrypt[0]), end="")
...
print("2-1. K_prime =", end="")
kyber.printarray(K_prime)
print("2-2. r_prime =", end="")
kyber.printarray(r_prime)
